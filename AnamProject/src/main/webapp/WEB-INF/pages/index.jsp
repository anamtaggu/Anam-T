		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox" align="center">
				<div class="item active">
					<img src="resources/images/slider/q.jpg" alt="book" width="660" height="345">
				</div>

				<div class="item">
					<img src="resources/images/slider/s.jpg" alt="books"
						width="660" height="345">
				</div>
				
				<div class="item">
					<img src="resources/images/slider/books.jpg" alt="books"
						width="660" height="345">
				</div>
				
				<div class="item">
					<img src="resources/images/slider/g.jpg" alt="books"
						width="660" height="345">
				</div>
